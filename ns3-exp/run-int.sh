...
#cp ~/Github/robust-lora-old/robust-lora/res/sr_RGreedyc_1_264_0.txt ./sr_loc.txt
#cp ~/Github/robust-lora-old/robust-lora/res/gw_RGreedyc_1_264_0.txt ./gw_loc.txt
#destlog=log1
#start=`date +%s`
...
#cp ~/Github/robust-lora-old/robust-lora/res/sr_RGreedy_2_264_0.txt ./sr_loc.txt
#cp ~/Github/robust-lora-old/robust-lora/res/gw_RGreedy_2_264_0.txt ./gw_loc.txt
#destlog=log2
#start=`date +%s`
#./waf --run "adr --MType=Confirmed" > "$destlog" 2>&1
#end=`date +%s`
...
#cp ~/Github/robust-lora-old/robust-lora/res/sr_RGreedy_3_264_0.txt ./sr_loc.txt
#cp ~/Github/robust-lora-old/robust-lora/res/gw_RGreedy_3_264_0.txt ./gw_loc.txt
#destlog=log3
#start=`date +%s`
#./waf --run "adr --MType=Confirmed" > "$destlog" 2>&1
#end=`date +%s`
...
destlog=log1-130
start=`date +%s`
./waf --run "adr --MType=Confirmed --intfrPowerdBm=-130" > "$destlog" 2>&1
end=`date +%s`
runtime=$((end-start))
echo "$runtime" >> "$destlog"
...
destlog=log1-124
start=`date +%s`
./waf --run "adr --MType=Confirmed --intfrPowerdBm=-124" > "$destlog" 2>&1
end=`date +%s`
runtime=$((end-start))
echo "$runtime" >> "$destlog"
...
#cp ~/Github/robust-lora-old/robust-lora/res/sr_ICIOT_264_0.txt ./sr_loc.txt
#cp ~/Github/robust-lora-old/robust-lora/res/gw_ICIOT_264_0.txt ./gw_loc.txt
#destlog=logiciot
#start=`date +%s`
#./waf --run "adr --MType=Confirmed" > "$destlog" 2>&1
#end=`date +%s`
